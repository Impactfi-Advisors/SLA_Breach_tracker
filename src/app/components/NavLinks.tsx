  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <path d="M5 5V3a1 1 0 011-1h4a1 1 0 011 1v2" stroke="currentColor" strokeWidth="1.5"/>
        <path d="M5 9h2M9 9h2M5 12h2M9 12h2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
